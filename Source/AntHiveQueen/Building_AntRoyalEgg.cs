...
namespace AntiniumHiveQueen
{
    ...
    public class Building_AntRoyalEgg : Building
    {
        ...
        public void Hatch()
        {
            try
            {
                ...
                var request = new PawnGenerationRequest(hatcherPawn, queenFaction, PawnGenerationContext.NonPlayer, -1,
                    false, true, false, false, false, false, 1f, false, true, true, true, false, false, false, false,
                    0f, 0f, null, 1f, null, null, null, null, null, null, null, Gender.Female);
        ...
        public override string GetInspectString()
        {
            ...
            stringBuilder.AppendLine(string.Concat("AntEggIdealTemperature".Translate(), ": ",
